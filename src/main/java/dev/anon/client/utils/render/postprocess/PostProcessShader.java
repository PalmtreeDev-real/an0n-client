...
public abstract class PostProcessShader {
    ...
    protected PostProcessShader(RenderPipeline pipeline) {
        ...
        this.framebuffer = new TextureTarget(AnonClient.NAME + " PostProcessShader " + this.getClass().getSimpleName(), mc.getWindow().getWidth(), mc.getWindow().getHeight(), true);
    }
    ...
    private static final DynamicUniformStorage<UniformData> UNIFORM_STORAGE = new DynamicUniformStorage<>("AN0N - Post UBO", UNIFORM_SIZE, 16);
