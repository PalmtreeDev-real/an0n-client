...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = AnonClient.identifier("textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = AnonClient.identifier("textures/container-transparent.png");
