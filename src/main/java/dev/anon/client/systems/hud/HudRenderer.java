...
import dev.anon.client.renderer.*;
import dev.anon.client.renderer.text.CustomTextRenderer;
import dev.anon.client.renderer.text.Font;
import dev.anon.client.renderer.text.VanillaTextRenderer;
...
public class HudRenderer {
            ...
            for (Iterator<FontHolder> it = fontsInUse.values().iterator(); it.hasNext(); ) {
                ...
                if (fontHolder.visited) {
                    MeshRenderer.begin()
                        ...
                        .pipeline(AnonRenderPipelines.UI_TEXT)
    ...
    private static class FontHolder {
        ...
        public MeshBuilder getMesh() {
            if (mesh == null) mesh = new MeshBuilder(AnonRenderPipelines.UI_TEXT);
