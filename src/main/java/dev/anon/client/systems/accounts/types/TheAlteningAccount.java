...
public class TheAlteningAccount extends Account<TheAlteningAccount> implements TokenAccount {
    ...
    public boolean fetchInfo() {
        ...
        try {
            ...
            AnonClient.LOG.error("Invalid TheAltening credentials.");
            return false;
        } catch (Exception _) {
            AnonClient.LOG.error("Failed to fetch info for TheAltening account!");
            return false;
        }
    }
    ...
    public boolean login() {
        ...
        try {
            ...
            AnonClient.LOG.error("Failed to login with TheAltening.");
            return false;
        }
    }
    ...
    private WaybackAuthLib getAuth() {
        ...
        auth.setPassword("AN0N on Crack!");
