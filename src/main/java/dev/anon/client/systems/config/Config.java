...
package dev.anon.client.systems.config;
...
public class Config extends System<Config> {
    ...
    public final Setting<Boolean> titleScreenCredits = sgVisual.add(new BoolSetting.Builder()
        ...
        .description("Show AN0N credits on title screen")
        .defaultValue(true)
        .build()
    );
    ...
    public final Setting<Boolean> titleScreenSplashes = sgVisual.add(new BoolSetting.Builder()
        ...
        .description("Show AN0N splash texts on title screen")
        .defaultValue(true)
        .build()
    );
    ...
    public final Setting<String> customWindowTitleText = sgVisual.add(new StringSetting.Builder()
        ...
        .defaultValue("AN0N client | by Palmtreedev-real | Minecraft 26.1.2")
        .onChanged(_ -> mc.updateTitle())
        .build()
    );
    ...
    public final Setting<Boolean> chatFeedback = sgChat.add(new BoolSetting.Builder()
        .name("chat-feedback")
        .description("Sends chat feedback when an0n performs certain actions.")
        .defaultValue(true)
        .build()
    );
    ...
    public CompoundTag toTag() {
        ...
        tag.putString("version", AnonClient.VERSION.toString());
