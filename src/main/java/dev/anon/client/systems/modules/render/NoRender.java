...
import dev.anon.client.events.world.ParticleEvent;
...
public class NoRender extends Module {
    ...
    private void onRenderBlockEntity(RenderBlockEntityEvent event) {
        if (blockEntities.get().contains(((BlockEntityRenderStateAccessor) event.blockEntityState).anon$getBlockState().getBlock())) event.cancel();
    }
