...
import dev.anon.client.gui.screens.ContainerInventoryScreen;
import dev.anon.client.mixin.EntityAccessor;
import dev.anon.client.mixin.MobBucketItemAccessor;
...
import dev.anon.client.utils.misc.ByteCountDataOutput;
...
import dev.anon.client.utils.tooltip.*;
...
public class BetterTooltips extends Module {
    ...
    private void getTooltipData(TooltipDataEvent event) {
        ...
        // Fish peek
            ...
            EntityType<?> type = ((MobBucketItemAccessor) bucketItem).anon$getType();
            ...
            if (entity != null) {
                ...
                ((EntityAccessor) entity).anon$setInWater(true);
