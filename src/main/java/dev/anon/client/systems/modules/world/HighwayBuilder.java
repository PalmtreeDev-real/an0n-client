...
import dev.anon.client.mixin.MinecraftMixin;
import dev.anon.client.mixin.ShulkerBoxMenuAccessor;
...
import dev.anon.client.systems.modules.combat.KillAura;
...
import dev.anon.client.utils.misc.HorizontalDirection;
import dev.anon.client.utils.misc.MBlockPos;
import dev.anon.client.utils.player.*;
...
import dev.anon.client.utils.world.Dir;
        ...
        Forward {
            ...
            private boolean isCrystalTrap(HighwayBuilder b) {
                for (Entity entity : b.mc.level.entitiesForRendering()) {
                    ...
                    ((IVec3) vec1).anon$set(b.mc.player.getX(), b.mc.player.getY() + b.mc.player.getEyeHeight(), b.mc.player.getZ());
                    ((IVec3) vec2).anon$set(entity.getX(), entity.getY() + 0.5, entity.getZ());
                ...
                switch (blockState.getBlock()) {
                    ...
                    case ShulkerBoxBlock _ -> {
                        if (b.mc.screen instanceof ShulkerBoxScreen screen) {
                            ...
                            Container inv = ((ShulkerBoxMenuAccessor) screen.getMenu()).anon$getContainer();
