...
import dev.anon.client.mixin.MapTextureManagerAccessor;
...
public class SaveMapCommand extends Command {
    ...
    private void saveMap(int scale) throws CommandSyntaxException {
        ...
        MapTextureManager.MapInstance texture = textureManager.anon$invokeGetOrCreateMapInstance(map.get(DataComponents.MAP_ID), state);
        ...
        try {
            ...
            AnonClient.LOG.error(e.toString());
        }
    }
