...
import dev.anon.client.systems.modules.misc.swarm.SwarmConnection;
import dev.anon.client.systems.modules.misc.swarm.SwarmWorker;
import dev.anon.client.systems.modules.world.InfinityMiner;
                ...
                .then(argument("port", IntegerArgumentType.integer(0, 65535))
                    .executes(context -> {
                        ...
                        info(Component.literal("Click here to confirm").setStyle(Style.EMPTY
                            ...
                            .withClickEvent(new AnonClickEvent(".swarm join confirm"))
                        ));
