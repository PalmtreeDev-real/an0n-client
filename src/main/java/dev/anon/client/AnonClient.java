...
import dev.anon.client.systems.hud.screens.AddHudElementScreen;
import dev.anon.client.systems.hud.screens.HudEditorScreen;
import dev.anon.client.systems.hud.screens.HudElementScreen;
import dev.anon.client.systems.modules.Categories;
import dev.anon.client.systems.modules.Modules;
import dev.anon.client.systems.modules.misc.DiscordPresence;
import dev.anon.client.utils.PostInit;
import dev.anon.client.utils.PreInit;
import dev.anon.client.utils.ReflectInit;
import dev.anon.client.utils.Utils;
import dev.anon.client.utils.misc.Version;
...
public class AnonClient implements ClientModInitializer {
    public static final String MOD_ID = "anon-client";
    public static final ModMetadata MOD_META;
    public static final String NAME;
    public static final Version VERSION;
    public static final String BUILD_NUMBER;

    public static AnonClient INSTANCE;
    public static AnonAddon ADDON;
    ...
    static {
        ...
        BUILD_NUMBER = MOD_META.getCustomValue(AnonClient.MOD_ID + ":build_number").getAsString();
    }
    ...
    public void onInitializeClient() {
        ...
        // Initialise addons
        AddonManager.ADDONS.forEach(AnonAddon::onInitialize);
    ...
    public static Identifier identifier(String path) {
        return Identifier.fromNamespaceAndPath(AnonClient.MOD_ID, path);
    }
}
