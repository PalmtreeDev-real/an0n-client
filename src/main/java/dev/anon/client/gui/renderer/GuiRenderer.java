...
import dev.anon.client.gui.renderer.operations.TextOperation;
import dev.anon.client.gui.renderer.packer.GuiTexture;
import dev.anon.client.gui.renderer.packer.TexturePacker;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(AnonClient.identifier("textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(AnonClient.identifier("textures/icons/gui/triangle.png"));
        EDIT = addTexture(AnonClient.identifier("textures/icons/gui/edit.png"));
        RESET = addTexture(AnonClient.identifier("textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(AnonClient.identifier("textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(AnonClient.identifier("textures/icons/gui/favorite_yes.png"));

        COPY = addTexture(AnonClient.identifier("textures/icons/gui/copy.png"));
        PASTE = addTexture(AnonClient.identifier("textures/icons/gui/paste.png"));
