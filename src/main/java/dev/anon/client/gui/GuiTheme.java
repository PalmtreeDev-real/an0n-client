...
import dev.anon.client.gui.screens.ModuleScreen;
import dev.anon.client.gui.screens.ModulesScreen;
import dev.anon.client.gui.screens.NotebotSongsScreen;
import dev.anon.client.gui.screens.ProxiesScreen;
import dev.anon.client.gui.screens.accounts.AccountsScreen;
import dev.anon.client.gui.tabs.TabScreen;
import dev.anon.client.gui.utils.CharFilter;
import dev.anon.client.gui.utils.SettingsWidgetFactory;
import dev.anon.client.gui.utils.WindowConfig;
import dev.anon.client.gui.widgets.*;
import dev.anon.client.gui.widgets.containers.*;
import dev.anon.client.gui.widgets.input.*;
