...
import dev.anon.client.gui.widgets.WHorizontalSeparator;

public class WAnonHorizontalSeparator extends WHorizontalSeparator implements AnonWidget {
    public WAnonHorizontalSeparator(String text) {
        super(text);
    }
