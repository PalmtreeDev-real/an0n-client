...
import dev.anon.client.gui.themes.anon.widgets.WAnonLabel;
...
public class WAnonTextBox extends WTextBox implements AnonWidget {
    private boolean cursorVisible;
    private double cursorTimer;

    private double animProgress;

    public WAnonTextBox(String text, String placeholder, CharFilter filter, Class<? extends Renderer> renderer) {
    ...
    private static class CompletionItem extends WAnonLabel implements ICompletionItem {
