...
public class WAnonDropdown<T> extends WDropdown<T> implements AnonWidget {
    public WAnonDropdown(T[] values, T value) {
        super(values, value);
    }
    ...
    private static class WRoot extends WDropdownRoot implements AnonWidget {
        @Override
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            AnonGuiTheme theme = theme();
    ...
    private class WValue extends WDropdownValue implements AnonWidget {
        @Override
