...
import dev.anon.client.gui.renderer.packer.TextureRegion;
...
public class Renderer2D {
    ...
    public Renderer2D(boolean textured) {
        ...
        triangles = new MeshBuilder(textured ? AnonRenderPipelines.UI_TEXTURED : AnonRenderPipelines.UI_COLORED);
        lines = new MeshBuilder(AnonRenderPipelines.UI_COLORED_LINES);
    }
    ...
    public void render(String samplerName, GpuTextureView samplerView, GpuSampler sampler) {
        ...
        MeshRenderer.begin()
            ...
            .pipeline(AnonRenderPipelines.UI_COLORED_LINES)
            .mesh(lines)
            .end();

        MeshRenderer.begin()
            .attachments(Minecraft.getInstance().getMainRenderTarget())
            .pipeline(textured ? AnonRenderPipelines.UI_TEXTURED : AnonRenderPipelines.UI_COLORED)
            .mesh(triangles)
